      ...
      <>
        <section aria-label="section-two" className="container py-5">
          <div className="row position-relative mx-md-5 p-5 my-5 bg-violet align-items-center">
            <div className="col-md-7 text-center text-md-start py-2">
              <h2 className="text-white display-5 ps-md-4 py-md-2 py-5">
                Find out more <br /> about how we work
              </h2>
            </div>

            <div className="col-md-5 ps-md-5 text-center">
              <a
                className=" border active fw-bold border-2 ms-md-5 border-white px-4 py-2 text-white text-decoration-none "
                href="#ViewPlans"
              >
                HOW WE WORK
              </a>
